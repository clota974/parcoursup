$(document).ready(function() {
  ...
  setTimeout(function () {
    ...
    $("link").each(function(ix){
      var href = $(this).attr("href");
      $(this).attr("href", href+"?date=11.09.19")
    });
  }, 1);
  hideDialog();
...
hideDialog = function (){
  ...
  zoomImgTag = function(original){
    original = original.currentTarget;
    $(".imgzoom").addClass("show");

    var bg = $(original).attr("src");
    $(".imgzoom").css("background-image", `url('${bg}')`);
  }
